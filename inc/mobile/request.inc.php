...
$dluid=$_GPC['dluid'];//share id
		...
		$pid = $_GPC['pid'];
        $goods_list = pdo_fetchall("SELECT * FROM " . tablename($this -> table_goods) . " as t1," . tablename($this -> table_request) . "as t2 WHERE t1.goods_id=t2.goods_id AND from_user='{$fans['openid']}' AND t1.weid = '{$_W['uniacid']}' ORDER BY t2.createtime DESC");
